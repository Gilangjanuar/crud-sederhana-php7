            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="index.php?page=student-data">Data Mahasiswa</a>
                        <a class="dropdown-item" href="index.php?page=student-input">Input Data</a>
        ...
        <?php 
            if(isset($_GET['page'])){
                ...
                elseif($_GET['page']== 'student-input'){
                  ...
                  }elseif($_GET['page'] == "student-delete"){
                    include 'Pages/student-delete.php';
                  }
            }
            else{
        ?>
